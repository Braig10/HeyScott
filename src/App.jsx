  ...
  return(
    <div style={{minHeight:"100vh",background:C.bg,fontFamily:"'DM Sans',sans-serif"}}>
      ...
      <header style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px clamp(16px,5vw,48px)",position:"sticky",top:0,background:C.bg,zIndex:10,borderBottom:`1px solid ${C.border}`}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:24}}>
          ...
          <button onClick={()=>go("onboarding")}
            style={{background:sage,color:"#fff",border:"none",borderRadius:8,padding:"10px 22px",fontSize:13,fontWeight:600,cursor:"pointer",letterSpacing:0.1,transition:"background 0.15s"}}
      ...
      <section style={{maxWidth:820,margin:"0 auto",padding:"clamp(48px,8vw,88px) clamp(16px,4vw,32px) clamp(32px,5vw,64px)",textAlign:"center"}}>
        ...
        <h1 style={{fontFamily:"'Playfair Display',Georgia,serif",margin:"0 0 22px",lineHeight:1.08,letterSpacing:-1}}>
        ...
        <div style={{maxWidth:420,margin:"0 auto"}}>
          <button onClick={()=>go("onboarding")}
            style={{width:"100%",background:sage,color:"#fff",border:"none",borderRadius:10,padding:"17px 0",fontSize:15,fontWeight:600,cursor:"pointer",letterSpacing:0.2,transition:"background 0.15s"}}
            onMouseEnter={e=>e.currentTarget.style.background=sageDark}
            onMouseLeave={e=>e.currentTarget.style.background=sage}>
      ...
      <section style={{maxWidth:760,margin:"0 auto",padding:"clamp(36px,6vw,64px) clamp(16px,4vw,32px)"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:14}}>
          {features.map((f,i)=>(
            <div key={i}
              style={{background:C.white,borderRadius:16,padding:"24px 20px",border:`1px solid ${C.border}`,transition:"box-shadow 0.18s,transform 0.18s",cursor:"default"}}
      ...
      <section className="hs-final-cta" style={{maxWidth:680,margin:"0 auto",padding:"72px 32px 88px",textAlign:"center"}}>
        ...
        <div style={{maxWidth:420,margin:"0 auto"}}>
          <button onClick={()=>go("onboarding")}
            style={{width:"100%",background:sage,color:"#fff",border:"none",borderRadius:10,padding:"17px 0",fontSize:15,fontWeight:600,cursor:"pointer",marginBottom:16,transition:"background 0.15s"}}
            onMouseEnter={e=>e.currentTarget.style.background=sageDark}
            onMouseLeave={e=>e.currentTarget.style.background=sage}>
            Start your diagnostic
          </button>
  ...
  return(
    <Shell page="team" go={go} userRole="manager" panel={false}>
      <div style={{animation:"fadeUp 0.35s ease both",maxWidth:960}}>
        ...
        {/* Tabs */}
        <div style={{display:"flex",gap:4,marginBottom:20,background:C.white,borderRadius:12,padding:4,border:`1px solid ${C.border}`,overflowX:"auto",flexWrap:"wrap"}}>
          {tabs.map(t=>(
        ...
        {activeTab==="briefing" && (
          <div style={{animation:"fadeUp 0.3s ease both",display:"flex",flexDirection:"column",gap:14}}>
            ...
            {/* Header card */}
            <div style={{background:C.navy,borderRadius:16,padding:"20px 22px",display:"flex",alignItems:"flex-start",gap:14}}>
              ...
              <>
                ...
                {(briefing.actions||[]).map((action,i)=>(
                  <div key={i} style={{background:C.white,borderRadius:14,border:`2px solid ${action.priority==="high"?"#FECACA":action.priority==="medium"?"#FDE68A":C.border}`,padding:"18px 20px"}}>
                    ...
                    {action.script&&(
                      <div style={{background:C.bg,borderRadius:10,padding:"10px 14px",border:`1px solid ${C.border}`,marginBottom:8}}>
            ...
            <div style={{background:C.white,borderRadius:14,border:`1px solid ${C.border}`,padding:18}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:10}}>
                {[
                  ...
                  <div key={i} style={{background:section.bg,borderRadius:10,padding:"12px 14px"}}>
                ...
                .map(m=>{
                  ...
                  return(
                    <div key={m.id} style={{background:C.white,borderRadius:14,border:`1px solid ${m.status==="regressing"?"#FECACA":m.status==="plateau"?"#FDE68A":C.border}`,padding:"16px 18px"}}>
                      ...
                      {m.regressionNote && (
                        <div style={{background:"#FEF2F2",borderRadius:8,padding:"9px 12px",border:"1px solid #FECACA",marginTop:10}}>
                      ...
                      {m.status==="plateau" && !m.regressionNote && (
                        <div style={{background:"#FFFBEB",borderRadius:8,padding:"9px 12px",border:"1px solid #FDE68A",marginTop:10}}>
                ...
                return(
                  <div key={q.quad} style={{background:q.bg,borderRadius:14,border:`2px solid ${q.border}`,padding:"16px 18px",minHeight:160}}>
                    ...
                    <div style={{borderTop:`1px solid ${q.border}`,paddingTop:10,marginTop:8,display:"flex",flexDirection:"column",gap:8}}>
                      ...
                      {people.map(m=>(
                        <div key={m.id} style={{display:"flex",alignItems:"center",gap:8,cursor:"pointer",borderRadius:8,padding:"6px 8px",background:"rgba(255,255,255,0.5)",transition:"all 0.15s"}}
            ...
            {confSelected && (
              <div style={{background:C.white,borderRadius:14,border:`1px solid ${C.border}`,padding:"18px 20px",animation:"fadeUp 0.2s ease both"}}>
                ...
                {confSelected.hiddenGemNote && (
                  <div style={{background:"#EDE9FE",borderRadius:10,padding:"10px 14px",border:"1px solid #C4B5FD",marginBottom:10}}>
          ...
          <div style={{animation:"fadeUp 0.3s ease both",display:"flex",flexDirection:"column",gap:14}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:10}}>
              {[
                ...
                <div key={i} style={{background:s.bg,borderRadius:12,padding:"14px 16px",border:"1px solid transparent"}}>
                  <div style={{fontSize:22,marginBottom:4}}>{s.icon}</div>
            ...
            {analyticsTeam.filter(m=>m.flagNote).map(m=>(
              <div key={m.id} style={{background:C.white,borderRadius:12,border:`1px solid ${C.border}`,padding:"12px 16px",display:"flex",gap:10,alignItems:"flex-start"}}>
                <Av ini={m.ini} col={m.col} sz={28}/>
                <div>
